...
class LRFinder:
    ...
    def run(
        self, dataloader, min_lr=1e-7, max_lr=1.0, beta=0.98, divergence_threshold=2.5
    ):
    ...
    def plot(self):
        ...
        print(
            f"Recommended LR = {self.lrate[steepest_gradient_idx]} at loss={self.loss[steepest_gradient_idx]}"
        )
